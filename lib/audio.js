(function () {
  ...
  Sounds.prototype.buildSoundPool = function (maxSize) {
    ...
    this.deathsplosion.volume = 0.4;
    this.powerDown = new Audio('./assets/sound/powerDown.wav');
    this.powerDown.volume = 0.4;
    this.destruction = new Audio('./assets/sound/bigExplosion.wav');
    this.destruction.volume = 0.35;

    this.death.load();
    this.deathsplosion.load();
    this.powerDown.load();
    this.destruction.load();
  ...
  Sounds.prototype.playSound = function (sound) {
    switch(sound) {
      ...
      case 'explosion':
        ...
        break;
      case 'destruction':
        this.loadSound(this.destruction);
        break;
      case 'powerDown':
        this.loadSound(this.powerDown);
        break;
    }
  };
})();
